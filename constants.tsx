...
export const AR_LABELS = {
  ...
  confirmDeleteWithChildren: 'لا يمكن حذف هذه الفئة لأنها تحتوي على فئات فرعية. يرجى حذف الفئات الفرعية أولاً.',
  confirmDeleteWithProducts: 'تحتوي هذه الفئة على منتجات. سيؤدي حذفها إلى جعل هذه المنتجات بدون فئة. هل تريد المتابعة؟',
  ...
  confirmDeleteBrandWithProducts: 'هذه العلامة التجارية مرتبطة بمنتجات. سيؤدي حذفها إلى جعل هذه المنتجات بدون علامة تجارية. هل تريد المتابعة؟',
...
const ProductsIcon = () => <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"/></svg>;
const CategoryIcon = () => <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h16M4 18h7"/></svg>;
const SalesIcon = () => <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.592 1M12 8V7m0 11v1m-6-11h1m10 0h1M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2zm2-7h3m8-3v3m-8-8H7v9m6-9h4"/></svg>;
const POSIcon = () => <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 13h6m-3-3v6m5 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>;
const RefundsIcon = () => <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"/></svg>;
...
const DollarIcon = () => <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.592 1M12 8V7m0 11v1m-6-11h1m10 0h1M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>;
const CalendarIcon = () => <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>;
const ShoppingCartIcon = () => <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z"/></svg>;
const PackageIcon = () => <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4"/></svg>;
const ChartLineIcon = () => <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M16 12V6m-4 6V9m-4 6v-3m12-9H4a2 2 0 00-2 2v10a2 2 0 002 2h16a2 2 0 002-2V5a2 2 0 00-2-2z"/></svg>;
const ClockIcon = () => <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>;
const UsersMetricIcon = () => <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 20v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2m3-2h8m-4-8a4 4 0 11-8 0 4 4 0 018 0z"/></svg>;
const UsersIcon = () => <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 20v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2m3-2h8m-4-8a4 4 0 11-8 0 4 4 0 018 0z"/></svg>;


// Quick Action icons
const NewSaleIcon = () => <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>;
const AddProductIcon = () => <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 13h6m-3-3v6m5 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>;
const ViewCustomersIcon = () => <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>;
const ViewReportsIcon = () => <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>;

// Product action icons
const EditIcon = () => <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"/></svg>;
...
const SearchIcon = ({ className, ...props }: IconProps) => <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/></svg>;
// Fix: Updated to directly type props without React.FC to resolve potential IntrinsicAttributes error.
const CancelIcon = ({ className, ...props }: IconProps) => <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 18L18 6M6 6l12 12"/></svg>;
const GenerateBarcodeIcon = () => <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 10h1.5M16.5 10h1.5M3 14h1.5M16.5 14h1.5M14 7h1v1h-1V7zm0 4h1v1h-1v-1zm0 4h1v1h-1v-1zM5 7h1v1H5V7zm0 4h1v1H5v-1zm0 4h1v1H5v-1zm14-8h1v1h-1V7zm0 4h1v1h-1v-1zm0 4h1v1h-1v-1zM7 7h1v1H7V7zm0 4h1v1H7v-1zm0 4h1v1H7v-1zm-4 4h18a2 2 0 002-2V5a2 2 0 00-2-2H3a2 2 0 00-2 2v14a2 2 0 002 2z"/></svg>
// FIX: Update PlusIcon to accept className prop to resolve type error.
const PlusIcon = ({ className, ...props }: IconProps) => <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 4v16m8-8H4"/></svg>;
...
const GridViewIcon = () => <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"/></svg>;
const TableViewIcon = () => <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 10h18M3 14h18m-9-4v8m-7 0h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z"/></svg>;

const CashIcon = () => <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z" /></svg>;
const CreditCardIcon = () => <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" /></svg>;
const HandIcon = () => <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M7 11.5V14m0-2.5c-.9 0-1.5.6-1.5 1.5v.5c0 .9.6 1.5 1.5 1.5v-3.5zm0 0h.01M3.17 11.5a2.5 2.5 0 010-5h.33a2.5 2.5 0 012.5 2.5v.5a2.5 2.5 0 01-2.5 2.5h-.33a2.5 2.5 0 010-5zm3.66.01a2.5 2.5 0 010-5h.34a2.5 2.5 0 012.5 2.5v.5a2.5 2.5 0 01-2.5 2.5h-.34a2.5 2.5 0 010-5zm3.67.01a2.5 2.5 0 010-5h.33a2.5 2.5 0 012.5 2.5v.5a2.5 2.5 0 01-2.5 2.5h-.33a2.5 2.5 0 010-5zm3.67.01a2.5 2.5 0 010-5h.33a2.5 2.5 0 012.5 2.5v.5a2.5 2.5 0 01-2.5 2.5h-.33a2.5 2.5 0 010-5zM12 18.5v-7" /></svg>;
...
// Fix: Updated to directly type props without React.FC to resolve potential IntrinsicAttributes error.
const ChevronDownIcon = ({ className, ...props }: ChevronDownIconProps) => <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7"/></svg>;
...
export const METRIC_CARDS_DATA: MetricCardProps[] = [
  { id: 1, title: AR_LABELS.todaysSales, value: '$0.00', icon: <DollarIcon />, bgColor: 'bg-green-100', valueColor: 'text-green-600' },
  { id: 2, title: AR_LABELS.thisMonth, value: '$0.00', icon: <CalendarIcon />, bgColor: 'bg-orange-100', valueColor: 'text-orange-600' },
  { id: 3, title: AR_LABELS.todaysTransactions, value: '0', icon: <ShoppingCartIcon />, bgColor: 'bg-blue-100', valueColor: 'text-blue-600' },
  { id: 4, title: AR_LABELS.totalProducts, value: '1', icon: <PackageIcon />, bgColor: 'bg-purple-100', valueColor: 'text-purple-600' },
  { id: 5, title: AR_LABELS.lowStockProducts, value: '0', icon: <ChartLineIcon />, bgColor: 'bg-red-100', valueColor: 'text-red-600' },
  { id: 6, title: AR_LABELS.expiredProducts, value: '0', icon: <ClockIcon />, bgColor: 'bg-yellow-100', valueColor: 'text-yellow-600' },
  { id: 7, title: AR_LABELS.customersWithBalance, value: '0', icon: <UsersMetricIcon />, bgColor: 'bg-indigo-100', valueColor: 'text-indigo-600' },
];

export const QUICK_ACTIONS_DATA: QuickActionProps[] = [
  { id: 1, title: AR_LABELS.newSale, icon: <NewSaleIcon />, colorClass: 'bg-blue-500 hover:bg-blue-600 text-white', path: '/pos/new-sale' },
  { id: 2, title: AR_LABELS.addProduct, icon: <AddProductIcon />, colorClass: 'bg-gray-200 hover:bg-gray-300 text-gray-800', path: '/products/add-multi-unit' }, // Updated path
  { id: 3, title: AR_LABELS.viewCustomers, icon: <ViewCustomersIcon />, colorClass: 'bg-gray-200 hover:bg-gray-300 text-gray-800', path: '/customers' },
  { id: 4, title: AR_LABELS.viewReports, icon: <ViewReportsIcon />, colorClass: 'bg-gray-200 hover:bg-gray-300 text-gray-800', path: '/reports' },
];
...
export const ToggleSwitch: React.FC<{
  ...
  return (
    <div className="flex items-center justify-end">
      {label && <span className="text-sm font-medium text-gray-700 dark:text-gray-300 ml-3">{label}</span>}
      <button
        type="button"
        className={`${
          enabled ? 'bg-orange-500' : 'bg-gray-200 dark:bg-gray-600'
        } relative inline-flex items-center h-6 rounded-full w-11 transition-colors focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2`}
