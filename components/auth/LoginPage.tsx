    ...
    return (
        <div className="w-full max-w-md bg-white dark:bg-gray-800 shadow-xl rounded-2xl p-8 space-y-6">
            <div className="text-center">
                <h1 className="text-3xl font-bold text-orange-500">PoshPointHub</h1>
                <p className="text-gray-600 dark:text-gray-300 mt-2">{AR_LABELS.login}</p>
            </div>
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="text-sm text-left">
                    <a href="#" onClick={(e) => { e.preventDefault(); onForgotPassword(); }} className="font-medium text-orange-600 hover:text-orange-500">
